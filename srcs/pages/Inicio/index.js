    ...
    <View style={styles.containerBoxBemVindo}>
      ...
      <View style={styles.boxImagemPromo}>
        ...
        <Image
          ...
          source={require('../../imgs/cupom2.png')}
        />
      </View>
    ...
    <View style={styles.flex2}>
      ...
      <View style={styles.boxSubCategorias}>
        <ScrollView horizontal>
          <BotaoSub img={require('../../imgs/likevetor.png')} title={'Tudo'} />
          <BotaoSub img={require('../../imgs/30OFF.png')} title={'Até 30% OFF'} />
          <BotaoSub img={require('../../imgs/oferrs.png')} title={'Ofertas em Destaque'} />
          <BotaoSub img={require('../../imgs/megafone.png')} title={'Novidades'} />
          <BotaoSub img={require('../../imgs/BROFF.png')} title={'Vendedores Locais'} />
          <BotaoSub img={require('../../imgs/likevetor.png')} title={'Casa e Decorações'} />
          <BotaoSub img={require('../../imgs/likevetor.png')} title={'Tudo'} />
        </ScrollView>
      </View>
...
function CardPoduto({ data }) {
  ...
  return (
    <TouchableOpacity style={{ margin: '1%', width: '48%', height: 330, backgroundColor: 'white' }}>
      <Image resizeMode='contain' style={{ width: '100%', height: '65%' }} source={{ uri: imgProduto }} />
      <View style={{padding: 10}}>
        <Text numberOfLines={2} style={{color: '#2d2d2d', marginBottom: 5}}>{nomeProduto}</Text>
      
        {vendedorLocal ?
        <View style={{ borderWidth: 1,  width: '50%'}}>
        <Text style={{ textAlign: 'center', fontSize: 12 }}>Vendedor Local</Text>
        </View>
          :
          <View style={{ width: '50%'}}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: '10%' }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Text style={{marginTop: 4, color: '#ed4d29'}}>R$</Text>
            <Text style={{fontSize: 19,  color: '#ed4d29'}}>{valor},00</Text>
          </View>
...
export default function Inicio() {
  ...
  const [images, setimages] = useState([
    require('../../imgs/slide1.png'),
    require('../../imgs/slide2.png'),
    require('../../imgs/slide3.png'),
  ]);
  ...
  const produtos = [
    ...
    { id: 5, nomeProduto: 'Kit Patricia Abravanel Essence Jequiti', imgProduto: 'https://jequiti.vteximg.com.br/arquivos/ids/166932-850-850/16718.png?v=637855420603230000', valor: 5, vendas: 54, vendedorLocal: true, indicado: true, promo: 60 },
  ]
        ...
        <ScrollView
          ...
          <View style={styles.boxCategorias}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <BotaoCategoria img={require('../../imgs/image-removebg-preview.png')} title={'Moedas Shopee'} />
              <BotaoCategoria img={require('../../imgs/free.png')} title={'Frete Grátis'} />
              <BotaoCategoria img={require('../../imgs/sacola.png')} title={'Shopee Oficial'} />
              <BotaoCategoria img={require('../../imgs/batom.png')} title={'Clube de Beleza'} />
              <BotaoCategoria img={require('../../imgs/vendedores.png')} title={'Vendedores Internacionais'} />
            </ScrollView>
          </View>
          ...
          <View style={styles.boxCategorias}>
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              ...
              <BotaoCategoria img={require('../../imgs/consoile.png')} title={'Jogos e Prêmios'} />
              <BotaoCategoria img={require('../../imgs/cuponss.png')} title={'Cupons Diários'} />
              <BotaoCategoria img={require('../../imgs/pcecell.png')} title={'Espaço Tecnologia'} />
              <BotaoCategoria img={require('../../imgs/liveshopee.png')} title={'Shopee Live '} />
              <BotaoCategoria img={require('../../imgs/sacola.png')} title={'Shopee Doações'} />
              <BotaoCategoria img={require('../../imgs/image-removebg-preview.png')} title={'Moedas Shopee'} />
